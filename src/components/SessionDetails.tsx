                      ...
                      <div className="card my-0 shadow-none border">
                        <div className="">
                          <div className="row align-items-center">
                            <div className="col">
                              <h4 className="details-title">Device:</h4>
                              <hr className="m-0 hr-dashed" />
                              <p className="details-value my-0">Mobile (1)</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col-lg-2">
                      <div className="card my-0 shadow-none border">
                        <div className="">
                          <div className="row align-items-center">
                            <div className="col">
                              <h4 className="details-title">Location :</h4>
                              <hr className="m-0 hr-dashed" />
                              <p className="details-value my-0">Bouaké</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col-lg-2">
                      <div className="card my-0 shadow-none border">
                        <div className="">
                          <div className="row align-items-center">
                            <div className="col">
                              <h4 className="details-title">Login Time :</h4>
                              <hr className="m-0 hr-dashed" />
                              <p className="details-value my-0">2026-01-02 01:07</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col-lg-2">
                      <div className="card my-0 shadow-none border">
                        <div className="">
                          <div className="row align-items-center">
                            <div className="col">
                              <h4 className="details-title">Last Activity :</h4>
                              <hr className="m-0 hr-dashed" />
                              <p className="details-value my-0">2026-01-02 01:17</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col-lg-2">
                      <div className="card my-0 shadow-none border">
                        <div className="">
                          <div className="row align-items-center">
                            <div className="col">
                              <h4 className="details-title">Status:</h4>
                              <hr className="m-0 hr-dashed" />
                              <p className="details-value my-0">Active</p>
                            </div>
                          </div>
                        </div>
                      </div>
